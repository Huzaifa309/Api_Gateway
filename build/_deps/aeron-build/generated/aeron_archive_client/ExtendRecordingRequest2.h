...
#ifndef _AERON_ARCHIVE_CLIENT_EXTENDRECORDINGREQUEST2_CXX_H_
#define _AERON_ARCHIVE_CLIENT_EXTENDRECORDINGREQUEST2_CXX_H_
...
public:
    ...
    ExtendRecordingRequest2() = default;
    ...
    ExtendRecordingRequest2(char *buffer, const std::uint64_t bufferLength) :
        ExtendRecordingRequest2(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExtendRecordingRequest2(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExtendRecordingRequest2(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ExtendRecordingRequest2 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ExtendRecordingRequest2 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ExtendRecordingRequest2 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    ExtendRecordingRequest2 &sbeRewind()
    {
    ...
    {
        ExtendRecordingRequest2 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ExtendRecordingRequest2 &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ExtendRecordingRequest2 &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExtendRecordingRequest2 &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExtendRecordingRequest2 &streamId(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static const char *sourceLocationMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t sourceLocationId() SBE_NOEXCEPT
    {
        return 5;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t sourceLocationSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool sourceLocationInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t sourceLocationEncodingOffset() SBE_NOEXCEPT
    {
        return 28;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t sourceLocationEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::int32_t sourceLocationRaw() const SBE_NOEXCEPT
    {
        std::int32_t val;
    ...
    SBE_NODISCARD SourceLocation::Value sourceLocation() const
    {
        std::int32_t val;
        std::memcpy(&val, m_buffer + m_offset + 28, sizeof(std::int32_t));
        return SourceLocation::get(SBE_LITTLE_ENDIAN_ENCODE_32(val));
    }

    ExtendRecordingRequest2 &sourceLocation(const SourceLocation::Value value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    SBE_NODISCARD static const char *autoStopMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t autoStopId() SBE_NOEXCEPT
    {
        return 6;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t autoStopSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool autoStopInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t autoStopEncodingOffset() SBE_NOEXCEPT
    {
        return 32;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t autoStopEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::int32_t autoStopRaw() const SBE_NOEXCEPT
    {
        std::int32_t val;
    ...
    SBE_NODISCARD BooleanType::Value autoStop() const
    {
        std::int32_t val;
        std::memcpy(&val, m_buffer + m_offset + 32, sizeof(std::int32_t));
    ...
    ExtendRecordingRequest2 &autoStop(const BooleanType::Value value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExtendRecordingRequest2 &putChannel(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
    ...
    ExtendRecordingRequest2 &putChannel(const std::string &str)
    {
    ...
    #if __cplusplus >= 201703L
    ExtendRecordingRequest2 &putChannel(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExtendRecordingRequest2 &_writer)
{
    ExtendRecordingRequest2 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExtendRecordingRequest2", )";
    ...
    builder << ", ";
    builder << R"("sourceLocation": )";
    builder << '"' << writer.sourceLocation() << '"';

    builder << ", ";
    builder << R"("autoStop": )";
    builder << '"' << writer.autoStop() << '"';
