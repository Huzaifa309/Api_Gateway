...
#ifndef _AERON_ARCHIVE_CLIENT_ARCHIVEIDREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_ARCHIVEIDREQUEST_CXX_H_
...
public:
    ...
    ArchiveIdRequest(char *buffer, const std::uint64_t bufferLength) :
        ArchiveIdRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ArchiveIdRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ArchiveIdRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ArchiveIdRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ArchiveIdRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ArchiveIdRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        ArchiveIdRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ArchiveIdRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ArchiveIdRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ArchiveIdRequest &_writer)
{
    ArchiveIdRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ArchiveIdRequest", )";
