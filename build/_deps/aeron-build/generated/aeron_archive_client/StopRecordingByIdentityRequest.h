...
#ifndef _AERON_ARCHIVE_CLIENT_STOPRECORDINGBYIDENTITYREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_STOPRECORDINGBYIDENTITYREQUEST_CXX_H_
...
class StopRecordingByIdentityRequest
{
private:
...
public:
    ...
    StopRecordingByIdentityRequest() = default;
    ...
    StopRecordingByIdentityRequest(char *buffer, const std::uint64_t bufferLength) :
        StopRecordingByIdentityRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    StopRecordingByIdentityRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        StopRecordingByIdentityRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    StopRecordingByIdentityRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    StopRecordingByIdentityRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    StopRecordingByIdentityRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    StopRecordingByIdentityRequest &sbeRewind()
    {
    ...
    {
        StopRecordingByIdentityRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    StopRecordingByIdentityRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    StopRecordingByIdentityRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    StopRecordingByIdentityRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const StopRecordingByIdentityRequest &_writer)
{
    StopRecordingByIdentityRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "StopRecordingByIdentityRequest", )";
