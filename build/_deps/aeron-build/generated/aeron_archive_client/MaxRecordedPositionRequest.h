...
#ifndef _AERON_ARCHIVE_CLIENT_MAXRECORDEDPOSITIONREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_MAXRECORDEDPOSITIONREQUEST_CXX_H_
...
class MaxRecordedPositionRequest
{
private:
...
public:
    ...
    MaxRecordedPositionRequest() = default;

    MaxRecordedPositionRequest(
        char *buffer,
    ...
    MaxRecordedPositionRequest(char *buffer, const std::uint64_t bufferLength) :
        MaxRecordedPositionRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MaxRecordedPositionRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MaxRecordedPositionRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MaxRecordedPositionRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    MaxRecordedPositionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    MaxRecordedPositionRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    MaxRecordedPositionRequest &sbeRewind()
    {
    ...
    {
        MaxRecordedPositionRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    MaxRecordedPositionRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    MaxRecordedPositionRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    MaxRecordedPositionRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MaxRecordedPositionRequest &_writer)
{
    MaxRecordedPositionRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MaxRecordedPositionRequest", )";
