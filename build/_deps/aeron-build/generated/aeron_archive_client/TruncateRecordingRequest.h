...
#ifndef _AERON_ARCHIVE_CLIENT_TRUNCATERECORDINGREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_TRUNCATERECORDINGREQUEST_CXX_H_
...
class TruncateRecordingRequest
{
private:
...
public:
    ...
    TruncateRecordingRequest() = default;
    ...
    TruncateRecordingRequest(char *buffer, const std::uint64_t bufferLength) :
        TruncateRecordingRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    TruncateRecordingRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        TruncateRecordingRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    TruncateRecordingRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    TruncateRecordingRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    TruncateRecordingRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    TruncateRecordingRequest &sbeRewind()
    {
    ...
    {
        TruncateRecordingRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    TruncateRecordingRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    TruncateRecordingRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TruncateRecordingRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TruncateRecordingRequest &position(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const TruncateRecordingRequest &_writer)
{
    TruncateRecordingRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "TruncateRecordingRequest", )";
