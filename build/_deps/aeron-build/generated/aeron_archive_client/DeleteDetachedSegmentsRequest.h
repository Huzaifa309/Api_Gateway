...
#ifndef _AERON_ARCHIVE_CLIENT_DELETEDETACHEDSEGMENTSREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_DELETEDETACHEDSEGMENTSREQUEST_CXX_H_
...
class DeleteDetachedSegmentsRequest
{
private:
...
public:
    ...
    DeleteDetachedSegmentsRequest() = default;
    ...
    DeleteDetachedSegmentsRequest(char *buffer, const std::uint64_t bufferLength) :
        DeleteDetachedSegmentsRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    DeleteDetachedSegmentsRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        DeleteDetachedSegmentsRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    DeleteDetachedSegmentsRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    DeleteDetachedSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    DeleteDetachedSegmentsRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    DeleteDetachedSegmentsRequest &sbeRewind()
    {
    ...
    {
        DeleteDetachedSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    DeleteDetachedSegmentsRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    DeleteDetachedSegmentsRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    DeleteDetachedSegmentsRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const DeleteDetachedSegmentsRequest &_writer)
{
    DeleteDetachedSegmentsRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "DeleteDetachedSegmentsRequest", )";
