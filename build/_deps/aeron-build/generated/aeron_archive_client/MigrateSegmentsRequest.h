...
#ifndef _AERON_ARCHIVE_CLIENT_MIGRATESEGMENTSREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_MIGRATESEGMENTSREQUEST_CXX_H_
...
public:
    ...
    MigrateSegmentsRequest() = default;
    ...
    MigrateSegmentsRequest(char *buffer, const std::uint64_t bufferLength) :
        MigrateSegmentsRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MigrateSegmentsRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MigrateSegmentsRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MigrateSegmentsRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    MigrateSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    MigrateSegmentsRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    MigrateSegmentsRequest &sbeRewind()
    {
    ...
    {
        MigrateSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    MigrateSegmentsRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    MigrateSegmentsRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    MigrateSegmentsRequest &srcRecordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    MigrateSegmentsRequest &dstRecordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MigrateSegmentsRequest &_writer)
{
    MigrateSegmentsRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MigrateSegmentsRequest", )";
