...
#ifndef _AERON_ARCHIVE_CLIENT_STOPRECORDINGSUBSCRIPTIONREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_STOPRECORDINGSUBSCRIPTIONREQUEST_CXX_H_
...
class StopRecordingSubscriptionRequest
{
private:
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(14);
    ...
    StopRecordingSubscriptionRequest() = default;
    ...
    StopRecordingSubscriptionRequest(char *buffer, const std::uint64_t bufferLength) :
        StopRecordingSubscriptionRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    StopRecordingSubscriptionRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        StopRecordingSubscriptionRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    StopRecordingSubscriptionRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    StopRecordingSubscriptionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    StopRecordingSubscriptionRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    StopRecordingSubscriptionRequest &sbeRewind()
    {
    ...
    {
        StopRecordingSubscriptionRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    StopRecordingSubscriptionRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    StopRecordingSubscriptionRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    StopRecordingSubscriptionRequest &subscriptionId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const StopRecordingSubscriptionRequest &_writer)
{
    StopRecordingSubscriptionRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "StopRecordingSubscriptionRequest", )";
