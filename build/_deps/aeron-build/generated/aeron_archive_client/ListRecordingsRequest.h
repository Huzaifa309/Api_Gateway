...
#ifndef _AERON_ARCHIVE_CLIENT_LISTRECORDINGSREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_LISTRECORDINGSREQUEST_CXX_H_
...
public:
    ...
    ListRecordingsRequest(char *buffer, const std::uint64_t bufferLength) :
        ListRecordingsRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ListRecordingsRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ListRecordingsRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ListRecordingsRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ListRecordingsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ListRecordingsRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    ListRecordingsRequest &sbeRewind()
    {
    ...
    {
        ListRecordingsRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ListRecordingsRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ListRecordingsRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ListRecordingsRequest &fromRecordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ListRecordingsRequest &recordCount(const std::int32_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ListRecordingsRequest &_writer)
{
    ListRecordingsRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ListRecordingsRequest", )";
