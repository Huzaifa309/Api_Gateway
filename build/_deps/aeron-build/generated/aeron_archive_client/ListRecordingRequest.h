...
#ifndef _AERON_ARCHIVE_CLIENT_LISTRECORDINGREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_LISTRECORDINGREQUEST_CXX_H_
...
public:
    ...
    ListRecordingRequest(char *buffer, const std::uint64_t bufferLength) :
        ListRecordingRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ListRecordingRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ListRecordingRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ListRecordingRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ListRecordingRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ListRecordingRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    ListRecordingRequest &sbeRewind()
    {
    ...
    {
        ListRecordingRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ListRecordingRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ListRecordingRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ListRecordingRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ListRecordingRequest &_writer)
{
    ListRecordingRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ListRecordingRequest", )";
