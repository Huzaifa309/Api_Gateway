...
#ifndef _AERON_ARCHIVE_CLIENT_LISTRECORDINGSUBSCRIPTIONSREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_LISTRECORDINGSUBSCRIPTIONSREQUEST_CXX_H_
...
class ListRecordingSubscriptionsRequest
{
private:
...
public:
    ...
    ListRecordingSubscriptionsRequest() = default;
    ...
    ListRecordingSubscriptionsRequest(char *buffer, const std::uint64_t bufferLength) :
        ListRecordingSubscriptionsRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ListRecordingSubscriptionsRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ListRecordingSubscriptionsRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ListRecordingSubscriptionsRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ListRecordingSubscriptionsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ListRecordingSubscriptionsRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    ListRecordingSubscriptionsRequest &sbeRewind()
    {
    ...
    {
        ListRecordingSubscriptionsRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ListRecordingSubscriptionsRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ListRecordingSubscriptionsRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD static const char *pseudoIndexMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t pseudoIndexId() SBE_NOEXCEPT
    {
        return 3;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t pseudoIndexSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool pseudoIndexInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t pseudoIndexEncodingOffset() SBE_NOEXCEPT
    {
        return 16;
    }

    static SBE_CONSTEXPR std::int32_t pseudoIndexNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT32;
    }

    static SBE_CONSTEXPR std::int32_t pseudoIndexMinValue() SBE_NOEXCEPT
    {
        return INT32_C(-2147483647);
    }

    static SBE_CONSTEXPR std::int32_t pseudoIndexMaxValue() SBE_NOEXCEPT
    {
        return INT32_C(2147483647);
    }

    static SBE_CONSTEXPR std::size_t pseudoIndexEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::int32_t pseudoIndex() const SBE_NOEXCEPT
    {
        std::int32_t val;
    ...
    ListRecordingSubscriptionsRequest &pseudoIndex(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static const char *subscriptionCountMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t subscriptionCountId() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t subscriptionCountSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool subscriptionCountInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t subscriptionCountEncodingOffset() SBE_NOEXCEPT
    {
        return 20;
    }

    static SBE_CONSTEXPR std::int32_t subscriptionCountNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT32;
    }

    static SBE_CONSTEXPR std::int32_t subscriptionCountMinValue() SBE_NOEXCEPT
    {
        return INT32_C(-2147483647);
    }

    static SBE_CONSTEXPR std::int32_t subscriptionCountMaxValue() SBE_NOEXCEPT
    {
        return INT32_C(2147483647);
    }

    static SBE_CONSTEXPR std::size_t subscriptionCountEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::int32_t subscriptionCount() const SBE_NOEXCEPT
    {
        std::int32_t val;
    ...
    ListRecordingSubscriptionsRequest &subscriptionCount(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    SBE_NODISCARD static const char *applyStreamIdMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t applyStreamIdId() SBE_NOEXCEPT
    {
        return 5;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t applyStreamIdSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool applyStreamIdInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t applyStreamIdEncodingOffset() SBE_NOEXCEPT
    {
        return 24;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t applyStreamIdEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::int32_t applyStreamIdRaw() const SBE_NOEXCEPT
    {
        std::int32_t val;
    ...
    SBE_NODISCARD BooleanType::Value applyStreamId() const
    {
        std::int32_t val;
        std::memcpy(&val, m_buffer + m_offset + 24, sizeof(std::int32_t));
        return BooleanType::get(SBE_LITTLE_ENDIAN_ENCODE_32(val));
    }

    ListRecordingSubscriptionsRequest &applyStreamId(const BooleanType::Value value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ListRecordingSubscriptionsRequest &streamId(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ListRecordingSubscriptionsRequest &putChannel(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
    ...
    ListRecordingSubscriptionsRequest &putChannel(const std::string &str)
    {
    ...
    #if __cplusplus >= 201703L
    ListRecordingSubscriptionsRequest &putChannel(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ListRecordingSubscriptionsRequest &_writer)
{
    ListRecordingSubscriptionsRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ListRecordingSubscriptionsRequest", )";
    ...
    builder << ", ";
    builder << R"("pseudoIndex": )";
    builder << +writer.pseudoIndex();

    builder << ", ";
    builder << R"("subscriptionCount": )";
    builder << +writer.subscriptionCount();

    builder << ", ";
    builder << R"("applyStreamId": )";
    builder << '"' << writer.applyStreamId() << '"';
