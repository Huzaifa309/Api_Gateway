...
#ifndef _AERON_ARCHIVE_CLIENT_RECORDINGPOSITIONREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_RECORDINGPOSITIONREQUEST_CXX_H_
...
class RecordingPositionRequest
{
private:
...
public:
    ...
    RecordingPositionRequest() = default;
    ...
    RecordingPositionRequest(char *buffer, const std::uint64_t bufferLength) :
        RecordingPositionRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    RecordingPositionRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        RecordingPositionRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    RecordingPositionRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    RecordingPositionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    RecordingPositionRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    RecordingPositionRequest &sbeRewind()
    {
    ...
    {
        RecordingPositionRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    RecordingPositionRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    RecordingPositionRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    RecordingPositionRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const RecordingPositionRequest &_writer)
{
    RecordingPositionRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "RecordingPositionRequest", )";
