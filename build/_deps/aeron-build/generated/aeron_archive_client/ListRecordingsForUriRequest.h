...
#ifndef _AERON_ARCHIVE_CLIENT_LISTRECORDINGSFORURIREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_LISTRECORDINGSFORURIREQUEST_CXX_H_
...
class ListRecordingsForUriRequest
{
private:
...
public:
    ...
    ListRecordingsForUriRequest() = default;
    ...
    ListRecordingsForUriRequest(char *buffer, const std::uint64_t bufferLength) :
        ListRecordingsForUriRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ListRecordingsForUriRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ListRecordingsForUriRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ListRecordingsForUriRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ListRecordingsForUriRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ListRecordingsForUriRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    ListRecordingsForUriRequest &sbeRewind()
    {
    ...
    {
        ListRecordingsForUriRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ListRecordingsForUriRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ListRecordingsForUriRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD static const char *fromRecordingIdMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t fromRecordingIdId() SBE_NOEXCEPT
    {
        return 3;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t fromRecordingIdSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool fromRecordingIdInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t fromRecordingIdEncodingOffset() SBE_NOEXCEPT
    {
        return 16;
    }

    static SBE_CONSTEXPR std::int64_t fromRecordingIdNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t fromRecordingIdMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t fromRecordingIdMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t fromRecordingIdEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t fromRecordingId() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    ListRecordingsForUriRequest &fromRecordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ListRecordingsForUriRequest &recordCount(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    ListRecordingsForUriRequest &streamId(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ListRecordingsForUriRequest &putChannel(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
    ...
    ListRecordingsForUriRequest &putChannel(const std::string &str)
    {
    ...
    #if __cplusplus >= 201703L
    ListRecordingsForUriRequest &putChannel(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ListRecordingsForUriRequest &_writer)
{
    ListRecordingsForUriRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ListRecordingsForUriRequest", )";
    ...
    builder << ", ";
    builder << R"("fromRecordingId": )";
    builder << +writer.fromRecordingId();
