...
#ifndef _AERON_ARCHIVE_CLIENT_REPLICATEREQUEST2_CXX_H_
#define _AERON_ARCHIVE_CLIENT_REPLICATEREQUEST2_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_SCHEMA_VERSION = static_cast<std::uint16_t>(11);
    ...
    ReplicateRequest2(char *buffer, const std::uint64_t bufferLength) :
        ReplicateRequest2(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ReplicateRequest2(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ReplicateRequest2(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ReplicateRequest2 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ReplicateRequest2 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ReplicateRequest2 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        ReplicateRequest2 skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ReplicateRequest2 &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ReplicateRequest2 &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ReplicateRequest2 &srcRecordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ReplicateRequest2 &dstRecordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ReplicateRequest2 &stopPosition(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ReplicateRequest2 &channelTagId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ReplicateRequest2 &subscriptionTagId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ReplicateRequest2 &srcControlStreamId(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static const char *fileIoMaxLengthMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t fileIoMaxLengthId() SBE_NOEXCEPT
    {
        return 12;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t fileIoMaxLengthSinceVersion() SBE_NOEXCEPT
    {
        return 7;
    }

    SBE_NODISCARD bool fileIoMaxLengthInActingVersion() SBE_NOEXCEPT
    {
        return m_actingVersion >= fileIoMaxLengthSinceVersion();
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t fileIoMaxLengthEncodingOffset() SBE_NOEXCEPT
    {
        return 60;
    }

    static SBE_CONSTEXPR std::int32_t fileIoMaxLengthNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT32;
    }

    static SBE_CONSTEXPR std::int32_t fileIoMaxLengthMinValue() SBE_NOEXCEPT
    {
        return INT32_C(-2147483647);
    }

    static SBE_CONSTEXPR std::int32_t fileIoMaxLengthMaxValue() SBE_NOEXCEPT
    {
        return INT32_C(2147483647);
    }

    static SBE_CONSTEXPR std::size_t fileIoMaxLengthEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::int32_t fileIoMaxLength() const SBE_NOEXCEPT
    {
    ...
    ReplicateRequest2 &fileIoMaxLength(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    SBE_NODISCARD static const char *replicationSessionIdMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t replicationSessionIdId() SBE_NOEXCEPT
    {
        return 13;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t replicationSessionIdSinceVersion() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD bool replicationSessionIdInActingVersion() SBE_NOEXCEPT
    {
        return m_actingVersion >= replicationSessionIdSinceVersion();
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t replicationSessionIdEncodingOffset() SBE_NOEXCEPT
    {
        return 64;
    }

    static SBE_CONSTEXPR std::int32_t replicationSessionIdNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT32;
    }

    static SBE_CONSTEXPR std::int32_t replicationSessionIdMinValue() SBE_NOEXCEPT
    {
        return INT32_C(-2147483647);
    }

    static SBE_CONSTEXPR std::int32_t replicationSessionIdMaxValue() SBE_NOEXCEPT
    {
        return INT32_C(2147483647);
    }

    static SBE_CONSTEXPR std::size_t replicationSessionIdEncodingLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::int32_t replicationSessionId() const SBE_NOEXCEPT
    {
    ...
    ReplicateRequest2 &replicationSessionId(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ReplicateRequest2 &putSrcControlChannel(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
    ...
    ReplicateRequest2 &putSrcControlChannel(const std::string &str)
    {
    ...
    #if __cplusplus >= 201703L
    ReplicateRequest2 &putSrcControlChannel(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    ReplicateRequest2 &putLiveDestination(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        std::uint32_t lengthFieldValue = SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    ReplicateRequest2 &putLiveDestination(const std::string &str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ReplicateRequest2 &putLiveDestination(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    SBE_NODISCARD static const char *replicationChannelMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static const char *replicationChannelCharacterEncoding() SBE_NOEXCEPT
    {
        return "US-ASCII";
    }

    static SBE_CONSTEXPR std::uint64_t replicationChannelSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    bool replicationChannelInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    static SBE_CONSTEXPR std::uint16_t replicationChannelId() SBE_NOEXCEPT
    {
        return 11;
    }

    static SBE_CONSTEXPR std::uint64_t replicationChannelHeaderLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::uint32_t replicationChannelLength() const
    {
        std::uint32_t length;
        std::memcpy(&length, m_buffer + sbePosition(), sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    std::uint64_t skipReplicationChannel()
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        std::uint32_t lengthFieldValue;
    ...
    SBE_NODISCARD const char *replicationChannel()
    {
        std::uint32_t lengthFieldValue;
        std::memcpy(&lengthFieldValue, m_buffer + sbePosition(), sizeof(std::uint32_t));
        const char *fieldPtr = m_buffer + sbePosition() + 4;
    ...
    std::uint64_t getReplicationChannel(char *dst, const std::uint64_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    ReplicateRequest2 &putReplicationChannel(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        std::uint32_t lengthFieldValue = SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    std::string getReplicationChannelAsString()
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    std::string getReplicationChannelAsJsonEscapedString()
    {
        std::ostringstream oss;
        std::string s = getReplicationChannelAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getReplicationChannelAsStringView()
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    ReplicateRequest2 &putReplicationChannel(const std::string &str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
        }
        return putReplicationChannel(str.data(), static_cast<std::uint32_t>(str.length()));
    }

    #if __cplusplus >= 201703L
    ReplicateRequest2 &putReplicationChannel(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    {
        return m_actingVersion >= encodedCredentialsSinceVersion();
    }
    ...
    ReplicateRequest2 &putEncodedCredentials(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        std::uint32_t lengthFieldValue = SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    ReplicateRequest2 &putEncodedCredentials(const std::string &str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ReplicateRequest2 &putEncodedCredentials(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    SBE_NODISCARD static const char *srcResponseChannelMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static const char *srcResponseChannelCharacterEncoding() SBE_NOEXCEPT
    {
        return "US-ASCII";
    }

    static SBE_CONSTEXPR std::uint64_t srcResponseChannelSinceVersion() SBE_NOEXCEPT
    {
        return 10;
    }

    bool srcResponseChannelInActingVersion() SBE_NOEXCEPT
    {
        return m_actingVersion >= srcResponseChannelSinceVersion();
    }

    static SBE_CONSTEXPR std::uint16_t srcResponseChannelId() SBE_NOEXCEPT
    {
        return 15;
    }

    static SBE_CONSTEXPR std::uint64_t srcResponseChannelHeaderLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::uint32_t srcResponseChannelLength() const
    {
    ...
    std::uint64_t skipSrcResponseChannel()
    {
        if (m_actingVersion < 10)
        {
            return 0;
    ...
    SBE_NODISCARD const char *srcResponseChannel()
    {
        if (m_actingVersion < 10)
        {
            return nullptr;
    ...
    std::uint64_t getSrcResponseChannel(char *dst, const std::uint64_t length)
    {
        if (m_actingVersion < 10)
        {
            return 0;
    ...
    ReplicateRequest2 &putSrcResponseChannel(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        std::uint32_t lengthFieldValue = SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    std::string getSrcResponseChannelAsString()
    {
        if (m_actingVersion < 10)
        {
            return std::string("");
    ...
    std::string getSrcResponseChannelAsJsonEscapedString()
    {
        if (m_actingVersion < 10)
        {
            return std::string("");
        ...
        std::ostringstream oss;
        std::string s = getSrcResponseChannelAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getSrcResponseChannelAsStringView()
    {
        if (m_actingVersion < 10)
        {
            return std::string_view("");
    ...
    ReplicateRequest2 &putSrcResponseChannel(const std::string &str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
        }
        return putSrcResponseChannel(str.data(), static_cast<std::uint32_t>(str.length()));
    }

    #if __cplusplus >= 201703L
    ReplicateRequest2 &putSrcResponseChannel(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ReplicateRequest2 &_writer)
{
    ReplicateRequest2 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ReplicateRequest2", )";
    ...
    builder << ", ";
    builder << R"("fileIoMaxLength": )";
    builder << +writer.fileIoMaxLength();

    builder << ", ";
    builder << R"("replicationSessionId": )";
    builder << +writer.replicationSessionId();
    ...
    builder << ", ";
    builder << R"("replicationChannel": )";
    builder << '"' <<
        writer.getReplicationChannelAsJsonEscapedString().c_str() << '"';
    ...
    builder << ", ";
    builder << R"("srcResponseChannel": )";
    builder << '"' <<
        writer.getSrcResponseChannelAsJsonEscapedString().c_str() << '"';
...
SBE_NODISCARD static std::size_t computeLength(
    ...
    std::size_t replicationChannelLength = 0,
    std::size_t encodedCredentialsLength = 0,
    std::size_t srcResponseChannelLength = 0)
{
...
#pragma GCC diagnostic ignored "-Wtype-limits"
    ...
    length += replicationChannelHeaderLength();
    if (replicationChannelLength > 1073741824LL)
    {
        throw std::runtime_error("replicationChannelLength too long for length type [E109]");
    }
    length += replicationChannelLength;
    ...
    length += srcResponseChannelHeaderLength();
    if (srcResponseChannelLength > 1073741824LL)
    {
        throw std::runtime_error("srcResponseChannelLength too long for length type [E109]");
    }
    length += srcResponseChannelLength;
