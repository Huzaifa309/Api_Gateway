...
#ifndef _AERON_ARCHIVE_CLIENT_PURGESEGMENTSREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_PURGESEGMENTSREQUEST_CXX_H_
...
public:
    ...
    PurgeSegmentsRequest(char *buffer, const std::uint64_t bufferLength) :
        PurgeSegmentsRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    PurgeSegmentsRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        PurgeSegmentsRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    PurgeSegmentsRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    PurgeSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    PurgeSegmentsRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    PurgeSegmentsRequest &sbeRewind()
    {
    ...
    {
        PurgeSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    PurgeSegmentsRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    PurgeSegmentsRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    PurgeSegmentsRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    PurgeSegmentsRequest &newStartPosition(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const PurgeSegmentsRequest &_writer)
{
    PurgeSegmentsRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "PurgeSegmentsRequest", )";
