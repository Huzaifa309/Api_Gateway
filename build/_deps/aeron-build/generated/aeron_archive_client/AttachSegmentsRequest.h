...
#ifndef _AERON_ARCHIVE_CLIENT_ATTACHSEGMENTSREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_ATTACHSEGMENTSREQUEST_CXX_H_
...
public:
    ...
    AttachSegmentsRequest(char *buffer, const std::uint64_t bufferLength) :
        AttachSegmentsRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    AttachSegmentsRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        AttachSegmentsRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    AttachSegmentsRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    AttachSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    AttachSegmentsRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    AttachSegmentsRequest &sbeRewind()
    {
    ...
    {
        AttachSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    AttachSegmentsRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    AttachSegmentsRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    AttachSegmentsRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const AttachSegmentsRequest &_writer)
{
    AttachSegmentsRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "AttachSegmentsRequest", )";
