...
#ifndef _AERON_ARCHIVE_CLIENT_STARTPOSITIONREQUEST_CXX_H_
#define _AERON_ARCHIVE_CLIENT_STARTPOSITIONREQUEST_CXX_H_
...
public:
    ...
    StartPositionRequest(char *buffer, const std::uint64_t bufferLength) :
        StartPositionRequest(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    StartPositionRequest(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        StartPositionRequest(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    StartPositionRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    StartPositionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    StartPositionRequest &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    StartPositionRequest &sbeRewind()
    {
    ...
    {
        StartPositionRequest skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    StartPositionRequest &controlSessionId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    StartPositionRequest &correlationId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    StartPositionRequest &recordingId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const StartPositionRequest &_writer)
{
    StartPositionRequest writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "StartPositionRequest", )";
